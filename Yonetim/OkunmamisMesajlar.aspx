<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Yonetim.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="OkunmamisMesajlar.aspx.cs" Inherits="OkunmamisMesajlar" %>
...
<div class=" col-sm-9  col-md-10">
  <h2 class=" page-header Baslik slidbar_top"> Okunmamış Mesajlar </h2>
</div>
...
<asp:Panel ID="pnlMesaj" Visible="false" runat="server">
    ...
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtMail" class="form-control"  placeholder="Mail" runat="server"></asp:TextBox>
              ...
              <div class="form-group">
      <asp:Label  ID="Label4" runat="server" class="col-sm-3 lable_Color">Konu</asp:Label>
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtKonu" class="form-control"  placeholder="Konu" runat="server"></asp:TextBox>
    </div>
  </div>
...
<div class=" col-sm-9 col-md-6">
   ...
   <div class="panel panel-primary">
     <div class="panel-heading panel-heading-Height"><h5 class=" AltBaslik"> Okunmamış Mesajları Listele </h5></div>
     ...
     <asp:DataList ID="Dtlist" Visible="true" Width="100%" runat="server">
      ...
      <tr class="Tablo-bg Sekil">
        ...
        <th style="width:35%;" >Konu</th>
        <th style="width:25%;" >Tarih</th>
        <th style="width:5%;">Onayla</th>
             ...
             <table class="table table-hover ">
                 <tbody>
                     <tr>
                         ...
                         <td style="width:35%;"><%#Eval("Konu") %></td>
                        <td style="width:30%;"><%#Eval("GTarih") %></td>

                         <td style="width:5%;"><a href="OkunmamisMesajlar.aspx?Duzenle=<%#Eval("MsjId") %>">
                             <img src="images/addcross.png"></a></td>
                         <td style="width:5%;"><a href="OkunmamisMesajlar.aspx?Sil=<%#Eval("MsjId") %>" onclick='return confirm("Silmek istediğinizden emin misiniz?");'>
