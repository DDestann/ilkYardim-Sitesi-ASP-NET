<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Yonetim.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="Duyuru.aspx.cs" Inherits="Duyuru" %>
...
<div class=" col-sm-9  col-md-10">
  <h2 class=" page-header Baslik slidbar_top"> Duyurular </h2>
</div>
...
<div class=" col-sm-9 col-md-6">
   ...
   <div class="panel panel-primary">
     <div class="panel-heading panel-heading-Height"><h5 class=" AltBaslik"> Duyuru Listele </h5></div>
        ...
        <th  style="width:5%;">Sil</th>
         ...
         <itemtemplate>
             <table class="table table-hover ">
                 <tbody>
                     <tr>
                         <td style="width:30%;"><%#Eval("Baslik") %></td>
                         <td style="width:60%;"><%#metin_kisalt_yan(Eval("icerik").ToString().Trim()) %></td>
                                   
                         <td style="width:5%;"><a href="Duyuru.aspx?Duzenle=<%#Eval("DuyuruId") %>">
                             <img src="images/user_edit.png"></a></td>
                         <td style="width:5%;"><a href="Duyuru.aspx?Sil=<%#Eval("DuyuruId") %>" onclick='return confirm("Silmek istediğinizden emin misiniz?");'>
