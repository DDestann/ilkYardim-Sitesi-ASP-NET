...
public partial class Duyuru : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            {
                DataRow drDuzenle = db.GetDataRow("Select * From tblDuyuru where DuyuruId='" + Request.QueryString["Duzenle"] + "'");
            ...
            {
                db.execute("Delete From tblDuyuru Where DuyuruId='" + Request.QueryString["Sil"] + "'");
    ...
    protected void btnKaydet_Click(object sender, EventArgs e)
    {
            ...
            if (btnKaydet.Text == "Kaydet")
            {
                ...
                db.execute(" INSERT INTO tblDuyuru(Baslik,icerik,DuyuruTarih) Values( '" + txtBaslik.Text + "','" + txticerik.Text + "' ,'" + DateTime.Now.ToString() + "'  )");
                        Response.Redirect(Link + "?Durum=Kaydet");
                
            }
            else if (btnKaydet.Text == "Güncelle")
            {
                db.execute("Update tblDuyuru Set  Baslik='" + txtBaslik.Text + "' , icerik='" + txticerik.Text + "'  Where DuyuruId='" + Request.QueryString["Duzenle"] + "'");
