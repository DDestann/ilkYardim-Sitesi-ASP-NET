<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Yonetim.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="VideoAltKategori.aspx.cs" Inherits="VideoAltKategori" %>
...
<div class=" col-sm-9  col-md-10">
  <h2 class=" page-header Baslik slidbar_top">Video Alt Kategoriler </h2>
</div>
...
<div class="col-md-8"> <input type="text" class="form-control" placeholder="Search..."> </div>
      ...
      <asp:Label  ID="Label4" runat="server" class="col-sm-3 lable_Color">VideoAltKat&nbsp;ID</asp:Label>
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtAltKatId" class="form-control"  placeholder="AltKategori ID" runat="server"></asp:TextBox>
    </div>
  </div>
              ...
              <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                  <ContentTemplate>
                                  <div class="form-group">
      <asp:Label  ID="Label1" runat="server" class="col-sm-3 lable_Color">VideoKat&nbsp;Adı</asp:Label>
    <div class="col-sm-9 ">
        <asp:DropDownList ID="drpVideoKat" class="form-control"  runat="server" AutoPostBack="True"></asp:DropDownList>
    </div>
  </div>
                      <div class="clearfix"></div>
                  </ContentTemplate>
              ...
              <div class="form-group">
      <asp:Label  ID="Label3" runat="server" class="col-sm-3 lable_Color">VideoAltKat&nbsp;Adı</asp:Label>
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtVideoAltKatAd" class="form-control"  placeholder="AltKategori Adı" runat="server"></asp:TextBox>
    </div>
  </div>
              ...
              <div class="clearfix"></div>
                                ...
                                <div class="form-group">
      <asp:Label  ID="Label2" runat="server" class="col-sm-3 lable_Color">Resim</asp:Label>
    <div class="col-sm-9 ">
        <asp:FileUpload ID="fluResim"  CssClass="form-control Flu" runat="server" />
              ...
              <div class="form-group">
      <asp:Label  ID="Label6" runat="server" class="col-sm-3 lable_Color">Video&nbsp;Link</asp:Label>
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtVideoLink" class="form-control"  TextMode="MultiLine" placeholder="Video Link" runat="server"></asp:TextBox>
    </div>
  </div>
...
<div class="clearfix"></div>
              ...
              <asp:Panel ID="pnlEskiResim" Visible="false" runat="server">
                  ...
                  <div class="form-group">
                      <asp:Label ID="Label5" runat="server" class="col-sm-3 lable_Color">Eski&nbsp;Resim</asp:Label>
                      <div class="col-sm-9 ">
...
<div class=" col-sm-9 col-md-6">
   ...
   <div class="panel panel-primary">
     <div class="panel-heading panel-heading-Height"><h5 class=" AltBaslik">Video Alt Kategori Listele </h5></div>
     ...
     <asp:DataList ID="Dtlist" Visible="true" Width="100%" runat="server">
      ...
      <tr class="Tablo-bg Sekil">
          ...
          <th style="width:20%;" >Video Resim</th>
          <th style="width:30%;" >Video Adı</th>
        <th style="width:35%;" >Video Kategori Adı</th>
        ...
        <th  style="width:5%;">Sil</th>
         ...
         <itemtemplate>
             <table class="table table-hover ">
                 <tbody>
                     <tr>
                         <td style="width: 5%;"><%#Eval("VideoAltKatId") %></td>
                         <td style="width: 20%;">
                             <img class="thumbnail" width="70" height="90" src="../images/yuklenen/Video/kucuk/<%#Eval("VideoResimYolu") %>" /></td>
                         <td style="width: 30%;"><%#Eval("VideoAdi") %></td>
                         <td style="width: 35%;"><%#Eval("VideoKatAdi") %></td>

                         <td style="width: 5%;"><a href="VideoAltKategori.aspx?Duzenle=<%#Eval("SanalVideoAltKatId") %>">
                             <img src="images/user_edit.png"></a></td>
                         <td style="width: 5%;"><a href="VideoAltKategori.aspx?Sil=<%#Eval("SanalVideoAltKatId") %>" onclick='return confirm("Silmek istediğinizden emin misiniz?");'>
