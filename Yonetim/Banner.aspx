<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Yonetim.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="Banner.aspx.cs" Inherits="Banner" %>
...
<div class="col-md-8"> <input type="text" class="form-control" placeholder="Search..."> </div>
      ...
      <asp:Label  ID="Label1" runat="server" class="col-sm-3 lable_Color">Banner&nbsp;Adı</asp:Label>
    <div class="col-sm-9 ">
   ...
   <div class="panel panel-primary">
     ...
     <asp:DataList ID="Dtlist" Visible="true" Width="100%" runat="server">
      ...
      <tr class="Tablo-bg Sekil">
        ...
        <th style="width:40%;" >Banner Adı</th>
         ...
         <itemtemplate>
             <table class="table table-hover ">
                 <tbody>
                     <tr>
                         <td style="width:40%;">
                             <img class="thumbnail" width="70" height="90" src="../images/yuklenen/Banner/kucuk/<%#Eval("BannerYolu") %>"  />
                         </td>
