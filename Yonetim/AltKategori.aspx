<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Yonetim.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="AltKategori.aspx.cs" Inherits="AltKategori" %>
...
<div class="col-md-8"> <input type="text" class="form-control" placeholder="Search..."> </div>
      ...
      <asp:Label  ID="Label4" runat="server" class="col-sm-3 lable_Color">AltKategori&nbsp;ID</asp:Label>
    <div class="col-sm-9 ">
    ...
    <div class="col-sm-9 ">
        <asp:DropDownList ID="drpKat" class="form-control"  runat="server" AutoPostBack="True"></asp:DropDownList>
    </div>
  </div>
                      <div class="clearfix"></div>
                  </ContentTemplate>
              ...
              <div class="form-group">
      <asp:Label  ID="Label3" runat="server" class="col-sm-3 lable_Color">AltKategori&nbsp;Adı</asp:Label>
    <div class="col-sm-9 ">
   ...
   <div class="panel panel-primary">
     ...
     <asp:DataList ID="Dtlist" Visible="true" Width="100%" runat="server">
      ...
      <tr class="Tablo-bg Sekil">
        ...
        <th style="width:45%;" >AltKategori Adı</th>
        ...
        <th  style="width:5%;">Sil</th>
         ...
         <itemtemplate>
             <table class="table table-hover ">
                 <tbody>
                     <tr>
                        <td style="width:5%;"><%#Eval("AltKatId") %></td>
                         <td style="width:40%;"><%#Eval("KatAdi") %></td>
                         <td style="width:45%;"><%#Eval("AltKatAdi") %></td>
                        
                         <td style="width:5%;"><a href="AltKategori.aspx?Duzenle=<%#Eval("AltSanalId") %>">
                             <img src="images/user_edit.png"></a></td>
                         <td style="width:5%;"><a href="AltKategori.aspx?Sil=<%#Eval("AltSanalId") %>" onclick='return confirm("Silmek istediğinizden emin misiniz?");'>
