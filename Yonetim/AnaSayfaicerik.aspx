<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Yonetim.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="AnaSayfaicerik.aspx.cs" Inherits="AnaSayfaicerik" %>
...
<div class=" col-sm-9  col-md-10">
  <h2 class=" page-header Baslik slidbar_top"> AnaSayfa icerik </h2>
</div>
             ...
             <table class="table table-hover ">
                 <tbody>
                     <tr>
                         ...
                         <td style="width:5%;"><a href="AnaSayfaicerik.aspx?Duzenle=<%#Eval("AnaicerikId") %>">
                             <img src="images/user_edit.png"></a></td>
                         <td style="width:5%;"><a href="AnaSayfaicerik.aspx?Sil=<%#Eval("AnaicerikId") %>" onclick='return confirm("Silmek istediğinizden emin misiniz?");'>
