<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Yonetim.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="OkunmusMesajlar.aspx.cs" Inherits="OkunmusMesajlar" %>
...
<div class=" col-sm-9  col-md-10">
  <h2 class=" page-header Baslik slidbar_top"> Okunmuş Mesajlar </h2>
</div>
...
<div class=" col-sm-9 col-md-6">
   ...
   <div class="panel panel-primary">
     <div class="panel-heading panel-heading-Height"><h5 class=" AltBaslik"> Okunmuş Mesajları Listele </h5></div>
                 ...
                 <tbody>
                     <tr>
                        ...
                        <td style="width:30%;"><%#Eval("GTarih") %></td>
                         ...
                         <td style="width:5%;"><a href="OkunmusMesajlar.aspx?Duzenle=<%#Eval("MsjId") %>">
                             <img src="images/add.png"></a></td>
                         <td style="width:5%;"><a href="OkunmusMesajlar.aspx?Sil=<%#Eval("MsjId") %>" onclick='return confirm("Silmek istediğinizden emin misiniz?");'>
