<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Yonetim.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="Ayarlar.aspx.cs" Inherits="Ayarlar" %>
...
<div class="col-md-8"> <input type="text" class="form-control" placeholder="Search..."> </div>
      ...
      <asp:Label  ID="Label11" runat="server" class="col-sm-3 lable_Color">ID</asp:Label>
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtId" class="form-control"  placeholder="Key"  runat="server" TextMode="Number"></asp:TextBox>
    </div>
  </div>
              <div class="form-group">
    ...
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtHost" class="form-control"  placeholder="smtp.Live.com && smtp.gmail.com"  runat="server" ></asp:TextBox>
    </div>
  </div>
    ...
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtYLİnk" class="form-control"  placeholder="Youtube"  runat="server" TextMode="MultiLine"></asp:TextBox>
                         ...
                         <div class="form-group">
      <asp:Label  ID="Label8" runat="server" class="col-sm-3 lable_Color">GooglePlus&nbsp;Link</asp:Label>
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtGLink" class="form-control"  placeholder="Google Plus"  runat="server" TextMode="MultiLine"></asp:TextBox>
    </div>
  </div>
              <div class="form-group">
             ...
             <table class="table table-hover ">
                 <tbody>
                     <tr>
                         ...
                         <td style="width:5%;"><a href="Ayarlar.aspx?Duzenle=<%#Eval("SanalId") %>">
                             <img src="images/user_edit.png"></a></td>
                         <td style="width:5%;"><a href="Ayarlar.aspx?Sil=<%#Eval("SanalId") %>" onclick='return confirm("Silmek istediğinizden emin misiniz?");'>
