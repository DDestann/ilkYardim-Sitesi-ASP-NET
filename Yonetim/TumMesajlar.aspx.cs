...
public partial class TumMesajlar : System.Web.UI.Page
{


    string Baslik = "Tüm Mesajlar";
    string Link = "TumMesajlar.aspx";
    ...
    private void Listele()
    {
        ...
        DataTable dt = db.GetDataTable("Select * From tblMesajlar  ORDER BY MsjId DESC");
