<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Yonetim.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="Kategori.aspx.cs" Inherits="Kategori" %>
...
<div class=" col-sm-9  col-md-10">
  <h2 class=" page-header Baslik slidbar_top"> Kategoriler </h2>
</div>
...
<div class="col-md-8"> <input type="text" class="form-control" placeholder="Search..."> </div>
      ...
      <asp:Label  ID="Label1" runat="server" class="col-sm-3 lable_Color">Kategori&nbsp;ID</asp:Label>
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtKatId" class="form-control"  placeholder="Kategori ID" TextMode="Number" runat="server"></asp:TextBox>
    </div>
  </div>
    ...
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtKatAd" class="form-control"  placeholder="Kategori Adı" runat="server"></asp:TextBox>
    </div>
  </div>
        ...
        <th  style="width:5%;">Sil</th>
         ...
         <itemtemplate>
             <table class="table table-hover ">
                 <tbody>
                     <tr>
                         <td style="width:5%;"><%#Eval("KatId") %></td>
                         <td style="width:85%;"><%#Eval("KatAdi") %></td>
                        
                         <td style="width:5%;"><a href="Kategori.aspx?Duzenle=<%#Eval("SanalId") %>">
                             <img src="images/user_edit.png"></a></td>
                         <td style="width:5%;"><a href="Kategori.aspx?Sil=<%#Eval("SanalId") %>" onclick='return confirm("Silmek istediğinizden emin misiniz?");'>
