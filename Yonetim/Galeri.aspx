<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Yonetim.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="Galeri.aspx.cs" Inherits="Galeri" %>
         ...
         <itemtemplate>
             <table class="table table-hover ">
                 <tbody>
                     <tr>
                         <td style="width:40%;">
                             <img class="thumbnail" width="70" height="90" src="../images/yuklenen/Galeri/kucuk/<%#Eval("GaleriYolu") %>"  />
                         </td>
