<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Yonetim.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="Test.aspx.cs" Inherits="Test" %>
...
<div class=" col-sm-9  col-md-10">
  <h2 class=" page-header Baslik slidbar_top"> Test </h2>
</div>
...
<div class="col-md-8"> <input type="text" class="form-control" placeholder="Search..."> </div>
      ...
      <asp:Label  ID="Label1" runat="server" class="col-sm-3 lable_Color">Test&nbsp;ID</asp:Label>
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtTestId" class="form-control"  placeholder="Test ID" TextMode="Number" runat="server"></asp:TextBox>
    </div>
  </div>

              <div class="form-group">
      <asp:Label  ID="Label3" runat="server" class="col-sm-3 lable_Color">Test&nbsp;Adı</asp:Label>
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtTestAd" class="form-control"  placeholder="Test Adı" runat="server"></asp:TextBox>
    </div>
  </div>
...
<div class=" col-sm-9 col-md-6">
   ...
   <div class="panel panel-primary">
     <div class="panel-heading panel-heading-Height"><h5 class=" AltBaslik"> Test Listele </h5></div>
        ...
        <th  style="width:5%;">Sil</th>
         ...
         <itemtemplate>
             <table class="table table-hover ">
                 <tbody>
                     <tr>
                         <td style="width:5%;"><%#Eval("TestId") %></td>
                         <td style="width:85%;"><%#Eval("TestAdi") %></td>
                        
                         <td style="width:5%;"><a href="Test.aspx?Duzenle=<%#Eval("SanalTestId") %>">
                             <img src="images/user_edit.png"></a></td>
                         <td style="width:5%;"><a href="Test.aspx?Sil=<%#Eval("SanalTestId") %>" onclick='return confirm("Silmek istediğinizden emin misiniz?");'>
