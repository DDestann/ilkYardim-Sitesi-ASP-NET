<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Yonetim.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="TumMesajlar.aspx.cs" Inherits="TumMesajlar" %>
...
<div class=" col-sm-9  col-md-10">
  <h2 class=" page-header Baslik slidbar_top"> Tüm Mesajlar </h2>
</div>
...
<div class=" col-sm-9 col-md-6">
   ...
   <div class="panel panel-primary">
     <div class="panel-heading panel-heading-Height"><h5 class=" AltBaslik"> Tüm Mesajları Listele </h5></div>
                 ...
                 <tbody>
                     <tr>
                        ...
                        <td style="width:30%;"><%#Eval("GTarih") %></td>
                         ...
                         <td style="width:5%;"><a href="TumMesajlar.aspx?Duzenle=<%#Eval("MsjId") %>">
                             <img src="images/user_edit.png"></a></td>
                         <td style="width:5%;"><a href="TumMesajlar.aspx?Sil=<%#Eval("MsjId") %>" onclick='return confirm("Silmek istediğinizden emin misiniz?");'>
