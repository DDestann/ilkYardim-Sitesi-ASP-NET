<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Yonetim.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="Yonetim.aspx.cs" Inherits="Yonetim" %>
...
<div class="col-md-8"> <input type="text" class="form-control" placeholder="Search..."> </div>
      ...
      <asp:Label  ID="Label4" runat="server" class="col-sm-3 lable_Color">Kullanıcı&nbsp;ID</asp:Label>
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtYoneticiId" class="form-control" TextMode="Number"  placeholder="Kullanıcı Id" runat="server"></asp:TextBox>
    </div>
  </div>
             ...
             <table class="table table-hover ">
                 <tbody>
                     <tr>
                         ...
                         <td  ><%#Eval("Sifre") %></td>
                         <td ><a href="Yonetim.aspx?Duzenle=<%#Eval("SanalYoneticiId") %>">
                             <img src="images/user_edit.png"></a></td>
                         <td ><a href="Yonetim.aspx?Sil=<%#Eval("SanalYoneticiId") %>" onclick='return confirm("Silmek istediğinizden emin misiniz?");'>
