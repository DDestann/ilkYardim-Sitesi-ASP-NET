<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Yonetim.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="AltAltKategori.aspx.cs" Inherits="AltAltKategori" %>
...
<div class=" col-sm-9  col-md-10">
  <h2 class=" page-header Baslik slidbar_top">Alt Alt Kategoriler </h2>
</div>
...
<div class="col-md-8"> <input type="text" class="form-control" placeholder="Search..."> </div>
      ...
      <asp:Label  ID="Label4" runat="server" class="col-sm-3 lable_Color">ID</asp:Label>
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtAltAltKatId" class="form-control"  placeholder="Alt Alt Kategori ID" runat="server"></asp:TextBox>
    </div>
  </div>
              ...
              <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                  <ContentTemplate>
                                  <div class="form-group">
      <asp:Label  ID="Label1" runat="server" class="col-sm-3 lable_Color">Kategori</asp:Label>
    <div class="col-sm-9 ">
        <asp:DropDownList ID="drpKat" class="form-control"  runat="server" AutoPostBack="True" OnSelectedIndexChanged="drpKat_SelectedIndexChanged"></asp:DropDownList>
                                           ...
                                           <div class="form-group">
      <asp:Label  ID="Label5" runat="server" class="col-sm-3 lable_Color">AltKategori</asp:Label>
    <div class="col-sm-9 ">
        <asp:DropDownList ID="drpAltKat" class="form-control"  runat="server" AutoPostBack="True"></asp:DropDownList>
    </div>
  </div>
                      <div class="clearfix"></div>
                  </ContentTemplate>
              ...
              <div class="form-group">
      <asp:Label  ID="Label3" runat="server" class="col-sm-3 lable_Color">Kategori&nbsp;Adı</asp:Label>
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtAltAltKatAd" class="form-control"  placeholder="Alt Alt Kategori Adı" runat="server"></asp:TextBox>
    </div>
  </div>
   ...
   <div class="panel panel-primary">
     ...
     <asp:DataList ID="Dtlist" Visible="true" Width="100%" runat="server">
      ...
      <tr class="Tablo-bg Sekil">
        ...
        <th style="width:28%;" >Kategori Adı</th>
        <th style="width:28%;" >AltKategori Adı</th>
         <th style="width:29%;" >AltAltKategori Adı</th>
        ...
        <th  style="width:5%;">Sil</th>
         ...
         <itemtemplate>
             <table class="table table-hover ">
                 <tbody>
                     <tr>
                        <td style="width:5%;"><%#Eval("AltAltKatId") %></td>
                         <td style="width:28%;"><%#Eval("KatAdi") %></td>
                         <td style="width:28%;"><%#Eval("AltKatAdi") %></td>
                         <td style="width:29%;"><%#Eval("AltAltKatAdi") %></td>
                        
                         <td style="width:5%;"><a href="AltAltKategori.aspx?Duzenle=<%#Eval("SanalAltAltKatId") %>">
                             <img src="images/user_edit.png"></a></td>
                         <td style="width:5%;"><a href="AltAltKategori.aspx?Sil=<%#Eval("SanalAltAltKatId") %>" onclick='return confirm("Silmek istediğinizden emin misiniz?");'>
