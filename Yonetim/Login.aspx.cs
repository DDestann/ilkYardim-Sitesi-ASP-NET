...
public partial class Yonetim_Login : System.Web.UI.Page
{
    ...
    protected void BtnLogin_Click(object sender, EventArgs e)
    {
        ...
        else if (txtSifre.Text == "")
        {
         ...
         else
         {
             ...
             DataRow drMail = db.GetDataRow("Select * From tblYonetim Where YoneticiMail='" + txtKullaniciAdi.Text + "'");
             if (drMail!=null)
             {
                 DataRow drSifre = db.GetDataRow("Select * From tblYonetim Where Sifre='" + txtSifre.Text + "' ");
                  if (drSifre != null)
                  {
                      DataRow dr = db.GetDataRow("Select * From tblYonetim Where YoneticiMail='" + txtKullaniciAdi.Text + "' AND Sifre='" + txtSifre.Text + "' ");
    ...
    protected void btnUnuttum_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            DataRow dr = db.GetDataRow("Select * From tblYonetim Where YoneticiMail='" + txtMailSifre.Text + "'");
