<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Yonetim.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="VideoKategori.aspx.cs" Inherits="VideoKategori" %>
...
<div class=" col-sm-9  col-md-10">
  <h2 class=" page-header Baslik slidbar_top">Video Kategori </h2>
</div>
...
<div class="col-md-8"> <input type="text" class="form-control" placeholder="Search..."> </div>
      ...
      <asp:Label  ID="Label1" runat="server" class="col-sm-3 lable_Color">Video ID</asp:Label>
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtVideoKatId" class="form-control"  placeholder="Video Kategori ID" TextMode="Number" runat="server"></asp:TextBox>
    </div>
  </div>

              <div class="form-group">
      <asp:Label  ID="Label3" runat="server" class="col-sm-3 lable_Color">VideoKat&nbsp;Adı</asp:Label>
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtVideoKatAd" class="form-control"  placeholder="Video Kategori Adı" runat="server"></asp:TextBox>
    </div>
  </div>
...
<div class=" col-sm-9 col-md-6">
   ...
   <div class="panel panel-primary">
     <div class="panel-heading panel-heading-Height"><h5 class=" AltBaslik">Video Kategori Listele </h5></div>
     ...
     <asp:DataList ID="Dtlist" Visible="true" Width="100%" runat="server">
      ...
      <tr class="Tablo-bg Sekil">
        ...
        <th style="width:85%;" >Video Kat Adı</th>
        ...
        <th  style="width:5%;">Sil</th>
         ...
         <itemtemplate>
             <table class="table table-hover ">
                 <tbody>
                     <tr>
                         <td style="width:5%;"><%#Eval("VideoKatId") %></td>
                         <td style="width:85%;"><%#Eval("VideoKatAdi") %></td>
                        
                         <td style="width:5%;"><a href="VideoKategori.aspx?Duzenle=<%#Eval("SanalVideoKatId") %>">
                             <img src="images/user_edit.png"></a></td>
                         <td style="width:5%;"><a href="VideoKategori.aspx?Sil=<%#Eval("SanalVideoKatId") %>" onclick='return confirm("Silmek istediğinizden emin misiniz?");'>
